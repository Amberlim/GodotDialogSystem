...
@onready var root_node_panel_instance = preload("res://Objects/RootNodePanel.tscn")
@onready var sentence_node_panel_instance = preload("res://Objects/SentenceNodePanel.tscn")
